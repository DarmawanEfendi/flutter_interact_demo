...
//go:generate swagger generate server --target ../../server --name SwaggerProfile --spec ../../schema/profile-spec.yml

func configureFlags(api *operations.SwaggerProfileAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SwaggerProfileAPI) http.Handler {
	...
	if api.ProfilePostProfileFavouriteHandler == nil {
		api.ProfilePostProfileFavouriteHandler = profile.PostProfileFavouriteHandlerFunc(func(params profile.PostProfileFavouriteParams) middleware.Responder {
			return middleware.NotImplemented("operation profile.PostProfileFavourite has not yet been implemented")
		})
	}
